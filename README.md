# IOC-Parser-Analyzer
An in-progress Python tool that extracts security indicators and saves them into organized text files. It can also scan log files and automatically check found hashes against the VirusTotal API to pull threat summaries.
